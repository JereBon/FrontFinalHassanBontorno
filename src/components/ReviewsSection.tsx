    ...
    return (
        <div className="mt-16 pt-16 border-t border-gray-200 dark:border-gray-800">
            ...
            <div className="space-y-4">
                {reviews.length === 0 ? (
                    <div className="soft-card py-16 text-center flex flex-col items-center justify-center">
                        ...
                        <p className="text-lg font-bold auto-text mb-1">Este producto aún no tiene reseñas.</p>
                        <p className="text-sm text-gray-500 dark:text-gray-400">¡Sé el primero en compartir tu opinión!</p>
                    </div>
                ) : (
